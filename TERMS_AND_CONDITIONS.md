...
> **Note (personal fork):** Telemetry is disabled by default in this fork. I use this project for personal learning only and do not collect any data. The terms below reflect the upstream project's policies and are kept here for reference.
...
Your data may be stored and processed in any country where I or my collaborators operate. By using Blender MCP, you consent to this transfer.
